...
import second from "../../assets/img/trading.png";
import third from "../../assets/img/blockchain.png";
function MakeLogin() {
  // const styles={
  //   innerWidth:'100px',
    ...
    <>
      <div className="bg-blue-flex-3">
        ...
        <div className="d-flex py-5  flex-column flex-lg-row align-items-center lg-vh-100 ">
          ...
          <img src={second} alt="second" className="rotate" />
        </div>
        <div className="d-flex py-5  flex-column flex-lg-row align-items-center lg-vh-100 ">
          <img src={third} alt="third" className="rotate" />
          <div className="container py-5">
